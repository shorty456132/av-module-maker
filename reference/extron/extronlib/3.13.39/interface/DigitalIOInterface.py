...
class DigitalIOInterface(Interface):
    ...
    data from Digital IO ports on Extron devices (:py:mod:`extronlib.device`).
    ...
    def __init__(self, Host, Port, Mode='DigitalInput', Pullup=False):
        ...
        :param Port: port name (e.g. ``'DIO1'``)
        :type Port: string
        :param Mode: Possible modes are: ``'DigitalInput'`` (default), and
            ``'DigitalOutput'``
        :type Mode: string
    ...
    def Initialize(self, Mode=None, Pullup=None):
        ...
        :param Mode: Possible modes are: ``'DigitalInput'``, and
            ``'DigitalOutput'``
        :type Mode: string
        :param Pullup: pull-up state on the port
        :type Pullup: bool
    ...
    def Mode(self):
        '''
        :return: mode of the Digital IO port (``'DigitalInput'``,
            ``'DigitalOutput'``)
        :rtype: string
        '''
        pass
