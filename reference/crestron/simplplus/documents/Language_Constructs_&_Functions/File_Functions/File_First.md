...
SIGNED_INTEGER FindFirst(STRING filespec, FILE_INFO info)

Description:

This command searches a directory for file(s) matching the given file specification. Always followed with a [FindClose](<FindClose.htm>). Requires [StartFileOperations()](<StartFileOperations.htm>).

[FileOpen](<FileOpen.htm>) and [FileDelete](<FileDelete.htm>) should be used in conjunction with FindFirst when necessary.
...
---
*Source: https://help.crestron.com/simpl_plus/Content/Language_Constructs_%26_Functions/File_Functions/File_First.htm*
