...
This function is the event function called when a connection is completed on a TCP_CLIENT or TCP_SERVER variable. The Status field of [SOCKET_STRUCT](<Direct_Socket_Access_Functions_Overview.htm>) holds the [returned values](<Status_Values.htm>) indicating the status of the connection attempt.
...
---
*Source: https://help.crestron.com/simpl_plus/Content/Language_Constructs_%26_Functions/Direct_Socket_Access/SocketConnect.htm*
