...
Finds the position in SOURCE_STRING where MATCH_STRING first occurs. The search is case sensitive.
...
START_POSITION is an INTEGER which tells FIND at what character in the string to start the search, and is 1 based. If it is not specified, it defaults to 1.
...
---
*Source: https://help.crestron.com/simpl_plus/Content/Language_Constructs_%26_Functions/String_Parsing_%26_Manipulation_Functions/FIND.htm*
