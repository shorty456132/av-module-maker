...
Number of bytes read from file into the string. If the return value is negative, it is an [error code](<File_Function_Return_Error_Codes.htm>). An error occurs if the string is not large enough to hold the data.
...
---
*Source: https://help.crestron.com/simpl_plus/Content/Language_Constructs_%26_Functions/File_Functions/ReadString.htm*
